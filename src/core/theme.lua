...
local THEMES = {
    light = {
        ...
        selectedStrong = imgui.ImVec4(0.70, 0.85, 1.0, 1.0),
        rowHover = imgui.ImVec4(0.84, 0.92, 1.0, 1.0),
    ...
    dark = {
        ...
        selectedStrong = imgui.ImVec4(0.05, 0.38, 0.66, 1.0),
        rowHover = imgui.ImVec4(0.14, 0.30, 0.46, 1.0),
