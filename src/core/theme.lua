...
local THEMES = {
    light = {
        ...
        selected = imgui.ImVec4(0.82, 0.91, 1.0, 1.0),
        selectedStrong = imgui.ImVec4(0.91, 0.95, 0.99, 1.0),
        rowHover = imgui.ImVec4(0.95, 0.97, 0.99, 1.0),
    ...
    dark = {
        ...
        selected = imgui.ImVec4(0.16, 0.34, 0.52, 1.0),
        selectedStrong = imgui.ImVec4(0.15, 0.21, 0.27, 1.0),
        rowHover = imgui.ImVec4(0.15, 0.18, 0.21, 1.0),
