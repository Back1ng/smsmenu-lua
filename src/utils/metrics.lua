...
TextMetrics.measureLeadingIndent = function(text, fontScaleMultiplier)
...
TextMetrics.estimateLines = function(text, maxWidth, fontScaleMultiplier)
    fontScaleMultiplier = fontScaleMultiplier or 1.0
